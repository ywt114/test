...
# 修改部分默认设置
sed -i "/signature/d" package/system/opkg/files/opkg-smime.conf
echo "# option check_signature" >> package/system/opkg/files/opkg-smime.conf
sed -i "/signature/d" package/system/opkg/files/opkg.conf
echo "# option check_signature" >> package/system/opkg/files/opkg.conf
